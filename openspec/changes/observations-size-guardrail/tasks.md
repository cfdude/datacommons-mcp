...
- [ ] 1.3 `tools/common.py`: add `ResultTooLargeError` to the `_CLIENT_FACING_ERRORS` tuple so `tool_error_boundary` surfaces its message (not masked).
