...
"""Search-indicators mixin for DCClient (native /api/nl/search-indicators flow)."""
...
from datacommons_mcp.clients._constants import DCID_TOPIC_PREFIX, SURFACE_HEADER
...
class _SearchMixin:
    """Search + existence-filtering methods for DCClient."""
